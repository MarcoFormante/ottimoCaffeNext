...
export default function Toast({quantity}:{quantity:number}){
  ...
  return (
    <div className="toast">
        <div className="toast-container flex items-center justify-between max-md:p-0 ">
            <div className="flex items-center gap-[10px] max-[370px]:gap-1">
            ...
            <Link className='text-base font-semibold underline' href={'/carrello'}>
                <span className="font-normal text-blue-text">Vai al carrello</span>
